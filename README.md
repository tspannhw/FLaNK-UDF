...
CREATE TABLE `ssb`.`Meetups`.`postgres_jdbc_meetupusers` (
	...
	`memberid` VARCHAR(2147483647),
	`seqid` VARCHAR(2147483647),
	`date` VARCHAR(2147483647),
	`ts` VARCHAR(2147483647),
	`filename` VARCHAR(2147483647),
	`uuid` VARCHAR(2147483647),
	`location` VARCHAR(2147483647),
    `joinedgroupon` VARCHAR(2147483647),
	`lastvisitedgroupon` VARCHAR(2147483647),
	`lastattended` VARCHAR(2147483647),
	`totalrsvps` VARCHAR(2147483647),
	`rsvpedyes` VARCHAR(2147483647),
	`rsvpedmaybe` VARCHAR(2147483647),
	`rsvpedno` VARCHAR(2147483647),
	`meetupsattended` VARCHAR(2147483647),
	`noshows` VARCHAR(2147483647),
	`introduction` VARCHAR(2147483647),
	`photostatus` VARCHAR(2147483647),
	`assistantorganizer` VARCHAR(2147483647),
